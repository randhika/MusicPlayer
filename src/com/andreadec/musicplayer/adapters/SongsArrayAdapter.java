...
public class SongsArrayAdapter extends ArrayAdapter<Object> {
	private final Context context;
	private final ArrayList<Object> values;
	private Song playingSong;
	private String directory;
 
	public SongsArrayAdapter(Context context, ArrayList<Object> values, Song playingSong, String directory) {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if (value instanceof File) {
			...
			textViewFolderItemFolder.setText(file.getName());
